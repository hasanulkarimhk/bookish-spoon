...
export function getData(){
  ...
  .then(blob => {
    ...
    let url = URL.createObjectURL(blob); //maybe understand blob and stuff a little bit better.
...
//This is a very important code for me, because this is one of the first times when i debug my code actually reading the errors. xx.
